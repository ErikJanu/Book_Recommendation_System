...
class Index():
    def __init__(self):
        first_100k_dataset = load_from_disk('first_hundred_k_dataset')
        second_100k_dataset = load_from_disk('second_hundred_k_dataset')
        last_22k_dataset = load_from_disk('third_and_final_dataset')
